...
class RsMultihorizonDefaultModel(nn.Module):
    def __init__(self, img_size=(3, 250, 250), locations=None, lstm_out_size=64, num_conv_blocks=2, pred_amount=1, final_actfn=torch.nn.Identity(), conv_init=None, lstm_init=None, fc_init=None, teacher_forcing_ratio=0.5):
        ...
        self.fc = nn.Linear(lstm_out_size, pred_amount)
    ...
    def forward(self, x_img, _):
        ...
        out      = self.activation_fn(out)                      # ↪ (i.e. the final contextualized representation of the sequence)
        return out  
