import sys, torch, os, datetime as dt, pandas as pd
...
class LinearRegressionModel(nn.Module):
    def __init__(self, input_size):
        ...
        self.linear = nn.Linear((input_size**2)*3, 1)  # Single linear layer
...
logger = TensorBoardLogger(save_dir="baselines/tblogs", name="FlattendLR", version=RUN_NAME, default_hp_metric=False)
hparams = {
